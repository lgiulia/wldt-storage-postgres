...
public class PostgresDigitalActionRequestService {
    ...
    public void saveRecord(DigitalActionRequestRecord record) throws StorageException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            throw new StorageException("Saving digital action request SQL error: " + e.getMessage());
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            throw new StorageException("Saving digital action request JSON error: " + e.getMessage());
        }
    }
    ...
    public Optional<DigitalActionRequestRecord> getLastRecord() throws StorageException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql);
            ...
            if (rs.next()) {
                ...
                DigitalActionRequestRecord record = objectMapper.readValue(json, DigitalActionRequestRecord.class);
                return Optional.of(record);
            }
        } catch (SQLException e) {
            e.printStackTrace();
            throw new StorageException("Digital action SQL error receiving last record: " + e.getMessage());
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            throw new StorageException("Digital action JSON processing error receiving last record: " + e.getMessage());
        }
    ...
    public List<DigitalActionRequestRecord> getRecordsInTimeRange(long startTimestampMs, long endTimestampMs) throws StorageException {
        List<DigitalActionRequestRecord> results = new ArrayList<>();
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            throw new StorageException("Digital action SQL error receiving records in time range: " + e.getMessage());
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            throw new StorageException("Digital action JSON processing error receiving records in time range: " + e.getMessage());
        }
        return results;
    }
    ...
    public List<DigitalActionRequestRecord> getRecordsInRange(int startIndex, int endIndex) throws StorageException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            throw new StorageException("Digital action SQL error receiving records in range: " + e.getMessage());
        } catch (JsonProcessingException e) {
            e.printStackTrace();
            throw new StorageException("Digital action JSON processing error receiving records in range: " + e.getMessage());
        }
        return results;
    }
